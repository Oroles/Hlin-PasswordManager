...
public class ReceivedAddGeneratedMessage extends ReceivedMessage {

    public ReceivedAddGeneratedMessage(IStore store, ReceivedProcessorController receivedProcessorController, String message) {
    ...
    public void execute() {
        ...
        mStore.getEncryption().appendHash("AddGenerated");
    }
}
